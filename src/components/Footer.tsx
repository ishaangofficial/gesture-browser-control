      ...
      <div className="max-w-[1400px] mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-primary">SparshMukhti</h2>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/studio" className="text-primary/70 hover:text-primary transition-colors">
                  OBS Simulator
                </Link>
              </li>
              <li>
                <Link to="/training" className="text-primary/70 hover:text-primary transition-colors">
                  Training
                </Link>
              </li>
              <li>
                <Link to="/library" className="text-primary/70 hover:text-primary transition-colors">
                  Gesture Library
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-primary/70">
        ...
        <div className="pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-primary/70 text-center md:text-left">
